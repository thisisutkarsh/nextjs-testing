...
const AdminNavbar: React.FC<AdminNavbarProps> = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <nav
      ...
      } top-0 z-40 mx-auto w-full flex-none bg-gray-100 dark:bg-slate-900 md:bg-gray-100/90 md:backdrop-blur-sm dark:md:bg-slate-900/90`}
      id="header"
    >
      <div className="mx-auto w-full max-w-7xl px-3 py-1 md:flex md:justify-between md:px-4 md:py-3.5">
        <div className="flex justify-between">
          ...
          <Link className="flex items-center py-3" href="/" prefetch={false}>
            <Logo />
          </Link>
        </div>
        <nav
                    ...
                    {links && links.length ? (
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          router.push(hrefValue as string);
                        }}
                      >
                        {label}
                      </button>
