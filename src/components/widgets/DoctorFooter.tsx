...
import { doctorFooterProps } from '../../shared/types';
        ...
        <div className="mx-auto max-w-7xl px-5 py-12 md:px-12 lg:px-20 lg:py-16">
          <div className="xl:grid xl:grid-cols-4 xl:gap-8">
            <div className="mt-12 lg:mt-0">
              ...
              <p className="mt-2 w-full text-base text-white lg:w-[90%]">{chatText}</p>
            </div>
              ...
              <ul role="list" className="mt-4 space-y-4">
                {quickLinks.map((link, index) => (
                  <li key={`quick-link-${index}`}>
                    <a href={link.href} className="text-base font-normal text-white hover:text-secondary">
                      {link.label}
                    </a>
                  </li>
                ))}
          ...
          <div className="mb-2 mt-12 flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="mb-8 mt-8 flex space-x-6 md:order-last md:mb-0 lg:mt-0">
              <Link href="https://facebook.com/babynamahq" target="_blank" className="text-white hover:text-secondary">
