...
export default function Footer3() {
   ...
   let showChatAgentButton = true;

   if (pathname === '/preview-access-landing') {
     showChatAgentButton = false;
   }
   ...
   return (
     <>
       {pathname === '/prime-care-plus' || pathname === '/lactation-history-form' ? (
         <WhatsAppButton />
       ) : (
           ...
           <div className="mx-auto max-w-7xl px-5 py-12 md:px-12 lg:px-20 lg:py-16">
             <div className="xl:grid xl:grid-cols-4 xl:gap-8">
               <div className="mt-12 lg:mt-0">
                 ...
                 <p className="mt-2 w-full text-base text-white lg:w-[90%]">
                   Babynama is a digital platform with a highly experienced and professional team of doctors to cater to
               ...
               {/* <div className="mt-12 lg:mt-0">
                 ...
                 <ul role="list" className="mt-4 space-y-4">
                   <li>
                     <button
                       onClick={() => handleQuickLinkClick('#pricing')}
                   ...
                   <li>
                     <button
                       onClick={() => handleQuickLinkClick('#testimonials')}
                       className="text-base font-normal text-white hover:text-secondary"
                     >
                       Our Doctors
                     </button>
                   ...
                   <li>
                     <button
                       onClick={() => handleQuickLinkClick('#doctors')}
                       className="text-base font-normal text-white hover:text-secondary"
                     >
                       Testimonials
                     </button>
                   ...
                   <li>
                     <button
                       onClick={() => handleQuickLinkClick('#why-babynama')}
                       className="text-base font-normal text-white hover:text-secondary"
                     >
                       About Us
                     </button>
                 ...
                 <ul role="list" className="mt-4 space-y-4">
                   ...
                   {showChatAgentButton && (
                     <li className="flex gap-2">
                       ...
                       <a
                         aria-label="Babynama"
                         href="https://api.whatsapp.com/send/?phone=%2B919540677121&text=Hi,%20I%20need%20help%20with%20Babynama"
                         className="text-base font-normal text-white hover:text-secondary"
                       >
             ...
             <div className="mb-2 mt-12 flex flex-col md:flex-row md:items-center md:justify-between">
               ...
               <div className="mb-8 mt-8 flex space-x-6 md:order-last md:mb-0 lg:mt-0">
                 <Link
                   href="https://facebook.com/babynamahq"
                   target="_blank"
                 ...
                 <Link href="https://instagram.com/babynamahq" className="text-white hover:text-secondary">
                 ...
                 <Link href="https://twitter.com/babynama" className="text-white hover:text-secondary">
